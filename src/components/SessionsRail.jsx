...
// because it's a one-off; promote it to common/Icon.jsx if a second caller appears.
const LinkIcon = () => (
    ...
    <div className="sessions-rail">
      <div className="sessions-rail-header">
        ...
        <div className="sessions-rail-header-actions">
          <IconButton label="New session" className="sessions-rail-new" onClick={onNewSession}>
            <Plus />
          </IconButton>
          <IconButton label="Close" className="sessions-rail-close" onClick={onClose}>
            <Close />
          </IconButton>
        </div>
      </div>
